...
For the hands-on project we will be using the Acupuncture data (acup_data.csv). The dataset contains data from a randomized study comparing acupuncture with placebo in the treatment of severe headache. The outcome studied here is the general health, measured as one of the sub-scales of the SF-36 health status
questionnaire. A low value indicates poor general health. A high value indicates good general health. A detailed description of the study can be found in Vickers et al. (BMJ Online, 2004, doi: 10.1136/bmj.38029.421863.EB).
...
• Ecxlude cases with missing data from your analysis. 

• Work and document your project in an R Notebook (you will find this in drive) and sent it via email at
